...
public class RainbowLootWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(RainbowLootWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/RainbowLootIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/RainbowLootIW/InitOutcome.xml").getDocumentElement();
