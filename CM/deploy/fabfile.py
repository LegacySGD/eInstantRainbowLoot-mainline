...
# date:             $DateTime: 2018/01/25 11:33:47 $
# Revision:         $Revision: #1 $
# file:             $File: //streams_rgs_games_einstant/eInstantRainbowLoot-mainline/CM/deploy/fabfile.py $
#
...
def GetGamesList(game_dir):
	...
	gl=[f for f in os.listdir(game_dir) if re.match(r'[0-9]+\-[0-9]+\-[0-9]+', f)]
	if gl:
	   return gl
	return [f for f in os.listdir(game_dir) if re.match(r'[0-9]+', f)]
